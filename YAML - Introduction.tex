...
\begin{frame}[fragile, allowframebreaks]{🗒 Block Style}
  ...
  \begin{enumerate}
    ...
    \item
      ...
      Next \alert{non-empty} line does not start with leading \alert{content whitespace}:
      \begin{enumerate}
        \item Empty Line(s): Remove first \code{\n}
        \item Non-Space Character at Start: Replace \code{\n} with space
      \end{enumerate}
